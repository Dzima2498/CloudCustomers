...
namespace CloudCustomers.UnitTests.Helpers
{
    internal static class MockHttpMessageHandler<T>
    {
        ...
        internal static Mock<HttpMessageHandler> SetupRetirn404()
        {
        ...
        internal static Mock<HttpMessageHandler> SetupBasicGetResourceList(List<User> expectedHandler, string endpoint)
        {
            var mockResponse = new HttpResponseMessage(System.Net.HttpStatusCode.OK)
            {
                Content = new StringContent(JsonConvert.SerializeObject(expectedHandler))
            ...
            var httpRequesrMessage = new HttpRequestMessage
            {
